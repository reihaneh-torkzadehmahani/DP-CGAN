...
#baseDir = "/content/gdrive/Team Drives/DPCGAN/"
...
def runTensorFlow(sigma, clippingValue, batchSize, epsilon, delta):
    ...
    mnist = input_data.read_data_sets(baseDir + "DP_CGAN_mnist/mnist_dataset", one_hot=True)
    ...
    resultDir = baseDir + "DP_CGAN_mnist/results"
