...
def runTensorFlow(batch_size, max_iteration_count):
    h_dim = 128
    Z_dim = 100

    # Initializations for a two-layer discriminator network
    mnist = input_data.read_data_sets(baseDir + "conditional-gan-mnist/mnist_dataset", one_hot=True)
...
runTensorFlow(batch_size, max_iteration_count)